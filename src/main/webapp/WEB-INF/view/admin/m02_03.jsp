        ...
        <div class="main_box">
            <section class="item_con">
                <div class="item_box">
                    ...
                    <form action="AdminController?action=m02_02" method="post">
                        <div class="items">
                            <span class="items_title">メールアドレス</span>
                            <span class="items_text">${pharmacyBean.p_email }</span>
                        </div>
                        <div class="items">
                            <span class="items_title">パスワード</span>
                            <span class="items_text">${pharmacyBean.p_pw }</span>
                        </div>
                        <div class="items">
                            <span class="items_title">薬局名</span>
                            <span class="items_text">${pharmacyBean.p_name }</span>
                        </div>
                        <div class="items">
                            <span class="items_title">電話番号</span>
                            <span class="items_text">${pharmacyBean.p_tel }</span>
                        </div>
                        <div class="items">
                            <span class="items_title">住所</span>
                            <span class="items_text">${pharmacyBean.p_address }</span>
                        </div>
                        <div class="btn_box">
