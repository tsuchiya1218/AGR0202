        ...
        <div class="main_box">
            <section class="item_con">
                <div class="item_box">
                    ...
                    <form action="AdminController?action=m03_s1_02" method="post">
                    <input type="hidden" name="h_num" value="${hospital.h_num }">
                        ...
                        <div class="items">
                            <label>
                                ...
                                <input type="text" name="name" value="${hospital.h_name }" autocomplete="off">
                            </label>
                        </div>
                        <div class="items">
                            <label class="tel">
                            	<c:set var="tel" value="${fn:split(hospital.h_tel,'-') }" />
                        ...
                        <div class="items">
                            <label>
                                ...
                                <input type="text" name="address" value="${hospital.h_address }">
                            </label>
                        </div>
                        <div class="btn_box">
