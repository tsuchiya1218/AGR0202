...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/doctor/u10_02_doctor.css">
        ...
        <div class="main_box">
            <section class="item_con">
                <div class="item_box">
                    ...
                    <form action="DoctorController?action=u10_s1" method="post">
                    ...
                    <div class="prescription_btn">
                    	<form action="DoctorController?action=u11_01" method="post">
                    		<input type="hidden" name="m_num" value="${member.m_num }">
                    		<input type="hidden" name="c_num" value="${children[index].c_num }">
	                    ...
	                    <table>
                            ...
                            <tbody>
                            	...
                            	<tr>
	                                ...
	                                <td>
	                                	<c:if test="${ep.ep_di_num ne null }">
		                                    <form action="DoctorController?action=u18_01" method="post">
	                                ...
	                                <td>
	                                    <form action="DoctorController?action=u13_01" method="POST">
