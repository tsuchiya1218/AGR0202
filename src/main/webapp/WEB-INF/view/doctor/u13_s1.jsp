...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/doctor/u13_s1.css">
    <title>電子処方箋変更画面</title>
</head>
<body id="body">
	<jsp:include page="../common/doctor/header.jsp"/>
    <main>
        <div class="main_box" id="main_box">
            <form action="DoctorController?action=u13_s1_02" method="POST">
            <input type="hidden" name="ep_num" value="${ep.ep_num }">
                <section class="item_con">
                    <div class="item_box">
                        ...
                        <div class="items_req">
                            <label id="ep_expiry_date">
                                ...
                                <input type="number" name="ep_expiry_date" value="${ep_expiry_date[2] }" placeholder="27" maxlength="2" min="0" oninput="maxLengthCheck(this)">
                            </label>
                        </div>
                        <div class="items">
                            <label>
                                <span class="items_title">公費負担番号</span>
                                <input type="number" name="ep_burden_num" value="${ep.ep_burden_num }" placeholder="公費負担番号" min="0" maxlength="20">
                            </label>
                        </div>
                        <div class="items">
                            <label>
                                <span class="items_title">公費負担医療の受験者</span>
                                <input type="text" name="ep_burden_person" value="${ep.ep_burden_person }" placeholder="公費負担医療の受験者" maxlength="50">
                            </label>
                        </div>
                    </div>
                    <div class="item_box">
                        <div class="items_radio">
                            ...
                            <c:if test="${ep.ep_patient_type eq '被保険者' }">
	                            <label>
                            ...
                            <c:if test="${ep.ep_patient_type eq '被扶養者' }">
	                            <label>
	                                <input type="radio" name="ep_patient_type" value="被保険者" checked>被保険者
	                            </label>
	                            <label>
                        ...
                        <div class="items">
                            <label>
                                ...
                                <c:set var="ep_reg_date" value="${fn:replace(ep.ep_reg_date,'/', '-') }"/>
                                <span class="items_text">${ep_reg_date }</span>
                            </label>
                        </div>
                        <div class="subtitle">
                            <h2>処方</h2>
                        ...
                        <div class="items_req">
                            <label>
                                ...
                                <input type="text" name="ep_disease" value="${ep.ep_disease }" placeholder="風邪" autocomplete="off" required>
                            </label>
                        </div>
                        <p>
                        ...
                        <div class="medicine_tap_menu" id="medicine_tap_menu">
                            ...
                            <div class="tap_menu_item_con">
                                <div class="tap_item_box">
                                    ...
                                    <div class="tap_item">
                                   	<c:forEach var="drug" items="${requestScope.drugList }">
                                   		<c:forEach var="checked" items="${requestScope.checked_drug }" >
                                   			<c:if test="${checked.drug_name eq drug.drug_name }">
		                                   		<label>${drug.drug_name }
		                                            <input type="checkbox" name="medicine_cbx[]" value="${drug.drug_name }" checked>
		                                        </label>
                                   			</c:if>
                                   		</c:forEach>
                                        <label>${drug.drug_name }
                    ...
                    <div class="items_another">
                        ...
                        <label>
                        	<c:set var="ep_note" value="${fn:replace(ep.ep_note,'&lt;br&gt;','&#10;')}" />
                            <textarea name="ep_note" maxlength="1000" placeholder="備考">${ep_note }</textarea>
                        </label>
                    </div>
                    <div class="items">
                        <label>
            ...
            <div class="hospital_info">
                ...
                <div class="btn_box">
                    ...
                    <button type="button" class="submit_btn" onclick="isSubmit(this.form);">確定</button>
                </div>
            </div>
        </form>
        </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/doctor/u13_s1.js"></script>
</html>