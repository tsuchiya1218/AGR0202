...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/pharmacy/u13.css">
                     ...
                     <div class="medicine_box">
                         <div class="medicine_items">
                                ...
                                <span class="items_text">${drug.drug_name }
                              	<a class="medicine_info_link" href="PharmacyController?action=u11_s3&medicine_name=${drug.drug_name }" target="_blank">
