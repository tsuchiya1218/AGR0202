...
<body id="body">
    ...
    <main>
        <div class="main_box" id="main_box">
            <form action="./u18_s1.html" method="POST">
            ...
            <div class="btn_box">
                <button type="button" onclick="history.back();">会員情報画面に戻る</button>
                <button type="submit" class="submit_btn" >薬剤情報提供書変更</button>
            </div>
        </form>
        </div>
