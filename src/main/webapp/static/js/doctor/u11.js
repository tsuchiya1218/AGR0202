            ...
            if(medicine_copy.getAttribute("id").indexOf(count) == -1){
                ...
                for(let index of medicine_cbx){
                    if(index.value === i.value){
						...
						medicine_copy.querySelectorAll('.pm_dosage')[0].disabled = false;
						medicine_copy.querySelectorAll('.pm_dosage')[1].disabled = false;
						medicine_copy.querySelector('#dosage_type').disabled = false;
						medicine_copy.querySelectorAll('.pm_dose')[0].disabled = false;
						medicine_copy.querySelectorAll('.pm_dose')[1].disabled = false;
						medicine_copy.querySelector('#dose_type').disabled = false;
